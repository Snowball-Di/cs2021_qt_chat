...
QT_MOC_LITERAL(3, 15, 5), // "login"
QT_MOC_LITERAL(4, 21, 15) // "slot_disconnect"

    },
    "Socket\0logout\0\0login\0slot_disconnect"
};
...
void Socket::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->logout((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->login((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< QString(*)>(_a[2]))); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Socket::logout)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (Socket::*_t)(int , QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Socket::login)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 1
void Socket::login(int _t1, QString _t2)
{
